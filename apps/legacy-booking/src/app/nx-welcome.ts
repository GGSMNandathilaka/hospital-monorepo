      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build legacy-booking
<span># Test</span>
nx test legacy-booking
<span># Lint</span>
nx lint legacy-booking
<span># Run them together!</span>
nx run-many -p legacy-booking -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project legacy-booking</pre>
          </details>
